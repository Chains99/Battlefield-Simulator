...
#Function Definition
fun_def += Production([def_t, fun_type, name_t, openBracket_t, params, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t])
fun_def += Production([def_t, fun_type, name_t, openBracket_t, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t])
...
if_def += Production([if_t, openBracket_t , expression, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t, else_def])
if_def += Production([if_t, openBracket_t , expression, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t])

#elif Definition
elif_def += Production([elif_t, openBracket_t ,expression, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t, elif_def])
elif_def += Production([elif_t, openBracket_t ,expression, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t, else_def])
elif_def += Production([elif_t, openBracket_t ,expression, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t])

#else Definition
else_def += Production([else_t, openCurlyBraces_t, statements, closedCurlyBraces_t])

#while Definition
while_def += Production([ while_t, openBracket_t , expression, closedBracket_t, openCurlyBraces_t, statements, closedCurlyBraces_t])
